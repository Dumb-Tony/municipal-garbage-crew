...
- Browser slice supports persistent remappable keyboard actions, clickable decisions, responsive presentation, mute, reduced-motion preference, and descriptive canvas labeling. Movement arrows and right Shift remain fixed fallbacks; reserved browser-navigation keys and conflicts are rejected. Gamepad/touch driving remain post-slice.
